...
if False:
    ...
    optim_ganlatent(material_dir / "optim_latent_256.json", 256, 0.02, [1000, 10, 10], tex_init=ckp)
...
if True:
    optim_ganlatent(material_dir / "optim_latent_256.json", 256, 0.02, [10, 10, 10], tex_init="auto")
